...
class WorkoutsController < ApplicationController
    ...
    @workouts_nearby = @workout.workouts_nearby
		...
		respond_to do |format|
			...
			format.js {render :js => @workout.to_json(:methods => [:json_hr, :json_heartrate_big, :json_speed, :json_speed_big, :json_elevation, :json_elevation_big, :json_comps, :gis, :cals], :except => :trackpoints, :include => [:activity, :user])}
		end
	end
